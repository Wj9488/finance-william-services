  ...
  return (
    <svg width="18" height="18" viewBox="0 0 18 18">
      ...
      <line
        ...
        y2="4"
        stroke="#3a0ca3"
        className='stroke-[#3a0ca3] dark:stroke-[#cae9ff]'
        strokeWidth="1"
...
const Nav = () => {
  ...
  return (
    <nav className='z-10 fixed top-0 lg:top-2 lg:right-4 bg-[#fafafa] dark:bg-[#070707] pr-2 lg:mt-0 lg:py-0 py-1 transition-colors duration-200 ease-in-out'>
